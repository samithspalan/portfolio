...
const socialLinks = [
  ...
  { name: 'GitHub', href: 'https://github.com/samithspalan', icon: <Github className="h-5 w-5" /> },
  { name: 'Twitter', href: 'https://twitter.com/samith17118', icon: <Twitter className="h-5 w-5" /> },
];
